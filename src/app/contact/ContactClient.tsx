          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-[#0B3D91] rounded-2xl p-7 text-white">
              ...
              <div className="space-y-5">
                ...
                <div className="flex gap-4 items-start">
                  <div className="w-10 h-10 rounded-xl bg-[#E1306C]/20 text-[#E1306C] flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-white/70 text-sm hover:text-[#E1306C] transition-colors mt-0.5 block"
                    >
...
function InstagramIcon({ fill = "currentColor" }: { fill?: string }) {
  return (
    <svg className="flex-shrink-0" width="20" height="20" viewBox="0 0 24 24" fill={fill} xmlns="http://www.w3.org/2000/svg">
