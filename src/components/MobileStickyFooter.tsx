    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-200 shadow-[0_-4px_12px_rgba(0,0,0,0.05)] md:hidden">
      <div className="flex">
        ...
        <a 
          ...
          className="flex-1 flex flex-col items-center justify-center py-2.5 text-white bg-[#25D366] active:bg-[#1db954] transition-colors border-r border-[#1db954]"
        >
        ...
        <a 
          ...
          className="flex-1 flex flex-col items-center justify-center py-2.5 text-white bg-[#072a6b] active:bg-[#0B3D91] transition-colors"
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="mb-0.5">
            <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
            <polyline points="22,6 12,13 2,6" />
          </svg>
          <span className="text-[11px] font-bold uppercase tracking-wider">Mail</span>
        </a>
      </div>
    </div>
  );
