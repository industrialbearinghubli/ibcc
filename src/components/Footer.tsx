      ...
      <div className="container-xl pt-16 pb-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            {/* Social icon circles — professional like desertcart */}
            <div className="flex items-center gap-3 mt-6">
              <a
                href="mailto:industrialbearing.hubli@gmail.com"
                aria-label="Email us"
                title="Email us"
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#0B3D91] border border-white/10 flex items-center justify-center transition-colors duration-200"
              >
                <EmailIconSm />
              </a>
              <a
                ...
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#25D366] border border-white/10 flex items-center justify-center transition-colors duration-200"
              >
                <WhatsAppIconSm />
              </a>
              <a
                href="https://www.instagram.com/industrialbearing.hubli"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram"
                title="Follow on Instagram"
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-gradient-to-tr border border-white/10 flex items-center justify-center transition-all duration-200 hover:bg-[#C13584]"
              >
                <InstagramIconSm />
              </a>
            </div>
          ...
          {/* Quick links */}
          <div>
            <h3 className="text-white font-bold text-xs uppercase tracking-widest mb-5 opacity-60">Quick Links</h3>
            <ul className="space-y-2.5">
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} className="footer-link flex items-center gap-2 text-sm">
          ...
          {/* Contact */}
          <div>
            <h3 className="text-white font-bold text-xs uppercase tracking-widest mb-5 opacity-60">Contact</h3>
...
// ── SMALL SOCIAL ICONS (for circles) ──────────────────────────────────────
