          ...
          <div className="flex items-center justify-between h-[70px]">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                className="hidden xl:flex items-center gap-2 bg-[#0B3D91] border border-white/20 text-white text-sm font-bold px-4 py-2 rounded-full transition-all hover:bg-white/20 hover:shadow-lg active:scale-95"
              >
                <MailIcon />
                Mail
              </a>
          ...
          <div className="border-t border-white/10 bg-[#072a6b]">
            <nav className="container-xl py-3 flex flex-col gap-1" aria-label="Mobile navigation">
              ...
              <div className="flex gap-3 mt-3 pb-2">
                ...
                <a
                  href="mailto:industrialbearing.hubli@gmail.com"
                  className="flex-1 flex items-center justify-center gap-2 bg-[#0B3D91] border border-white/20 text-white text-sm font-bold py-3 rounded-lg"
                >
                  <MailIcon />
                  Mail
                </a>
